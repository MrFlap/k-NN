...
namespace knn_jni {
    ...
    public:
        ...
        int dim, std::vector<std::vector<float>> *vect) = 0;
    ...
    public:
        ...
        void Convert2dJavaObjectArrayAndStoreToBatches(JNIEnv *env, jobjectArray array2dJ, int dim, std::vector<std::vector<float>> *vect);
